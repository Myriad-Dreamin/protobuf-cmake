...
macro(add_protobuf_library target)
    ...
    protobuf_internal_customized_generate_cpp(${target} PROTO_GENERATED_SRCS PROTO_GENERATED_HDRS ${ARGN})
...
macro(target_link_protobuf_libraries target linkage)
    ...
    if (NOT (NOT protobuf_dependencies))
        foreach(proto_lower ${protobuf_dependencies})
            target_link_protobuf_libraries(${proto_lower} ${linkage} ${ARGN})
        endforeach()
    endif()
